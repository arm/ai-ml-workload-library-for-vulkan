...
if(EXISTS ${GLSLANG_PATH}/CMakeLists.txt)
    if(NOT TARGET glslang)
        set(ENABLE_OPT OFF CACHE BOOL "Disable glslang optimizer" FORCE)
        set(ENABLE_GLSLANG_BINARIES OFF CACHE BOOL "Skip glslang binaries" FORCE)
        set(ENABLE_GLSLANG_JS OFF CACHE BOOL "Skip glslang JavaScript build" FORCE)
